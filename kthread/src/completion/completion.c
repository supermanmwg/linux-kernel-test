...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("mwg");
MODULE_DESCRIPTION("this is a test for completion and multiple thread");
...
static DECLARE_RWSEM(myrwsem);
static DECLARE_COMPLETION(mycompletion);
